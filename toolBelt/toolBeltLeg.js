...
depp.define({
    ...
    'debugCSS': 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/debug.css',
    ...
    'xterm': [
        ...
        'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/xterm/AttachAddon.min.js',
        'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/xterm/FitAddon.min.js'
    ]
    ...
    'accordion': ['#jquery', 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/jquery-accordion/js/jquery.accordion.min.js', 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/jquery-accordion/css/jquery.accordion.min.css'],
    ...
    ,
    'baseline': 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/baseline.min.js',
    'baseliner': ['#jquery', 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/baseliner.js'],
    'typewriter': 'https://cdn.jsdelivr.net/npm/typewriter-effect@2.12.1/dist/core.min.js',
    'letteringjs': ['#jquery', 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/letteringjs.min.js'],
    'flexibleArea': ['#jquery', 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/jquery.flexibleArea.min.js']
    // markdown UI
    ,
    ...
    //video
    ,
    'bideo': 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/bideo/bideo.min.js'
    //voice cmd
    ,
    'annYang': 'https://cdn.jsdelivr.net/npm/annyang@2.6.1/dist/annyang.min.js'
    //FX section
    ,
    'deli': ['https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.4.11/src/vendors/delighters.min.js']
    // transitions
    ,
