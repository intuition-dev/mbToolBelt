...
depp.define({
    ...
    ,'surveyitem-comp': ['https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.2.6/custel/surveryitem/custel/surveyitem-comp.min.js'],
    ...
    ,
    'parallaxImg': 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v8.2.6/src/vendors/parallaxImg.min.js'
