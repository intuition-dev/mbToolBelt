...
depp.define({
   ...
   'xterm': [
         ...
         'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v3.11.26/src/vendors/xterm/AttachAddon.min.js',
         'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v3.11.26/src/vendors/xterm/FitAddon.min.js'
         ]
  ...
  , 'parallaxImg': 'https://cdn.jsdelivr.net/gh/intuition-dev/mbToolBelt@v3.11.26/src/vendors/parallaxImg.min.js'
